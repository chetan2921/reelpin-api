...
class Settings(BaseSettings):
    ...
    WORKER_INSTAGRAM_CONCURRENCY: int = 2
    ...
    INSTAGRAM_TERTIARY_COOKIES_FILE: str | None = None
    ...
    INSTAGRAM_TERTIARY_COOKIE_DATA: str | None = None
    INSTAGRAM_TERTIARY_COOKIE_DATA_BASE64: str | None = None
